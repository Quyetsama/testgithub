    ...
    return <div className="border-end sidenav" id="sidebar-wrapper">
        ...
        <PerfectScrollbar className="sidebar-items">
            <ul className="list-unstyled ps-0">
                ...
                <li className="mb-1">
                    <Link tag="a" className="" to="/genre">
                        <i className="fa fa-file-o"></i> Genre
                    </Link>
                </li>
                <li className="mb-1">
                    <Link tag="a" className="" to="/movie">
                        <i className="fa fa-file-o"></i> Movie
                    </Link>
                </li>
                <li className="mb-1">
        ...
        <div className="dropdown fixed-bottom-dropdown">
            ...
            <ul className="dropdown-menu text-small shadow" aria-labelledby="dropdownUser2">
                ...
                <li><Link onClick={() => dispatch(logOut())} className="dropdown-item"><i className="fa fa-sign-out" aria-hidden="true"></i> Sign out</Link></li>
            </ul>
        </div>
    </div>
}
